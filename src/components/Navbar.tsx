...
export default class Navbar extends Component<Props, State> {
                 ...
                 drawerList = () => (
                   <div role="presentation" onClick={() => this.toggleDrawer(false)} onKeyDown={() => this.toggleDrawer(false)}>
                     <List>
                       {[{ name: "Main", viewName: "main" }, { name: "Graphs", viewName: "graphs" }, { name: "Registered users", viewName: "registeredUsers" }, { name: "Settings", viewName: "settings" }].map((info, index) => (
                 ...
                 render(): JSX.Element {
                   ...
                   return (
                     <AppBar color={"transparent"} position="static" elevation={10} style={{ marginBottom: "3vh" }}>
                       <Toolbar>
                         {mainBranding()}
                         <Button onClick={()=> changeToView("main")} color="inherit">Main</Button>
                         <Button color="inherit">Graphs</Button>
                         <Button onClick={() => changeToView("registeredUsers")} color="inherit">Registered users</Button>
